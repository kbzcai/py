...
class ReadS71200(object):
    ...
    def plc_connect(self, plc_ip1, plc_ip2, plc_ip3, plc_ip4, plc_ip5):
        try:
            global siemens1, siemens2, siemens3, siemens4, siemens5
            if self.state1[0] == 0:
    ...
    def main(self):
        if self.state1[0] == 1:
            self.insertDataDB(siemens1, "mes_plc_r11")
        if self.state1[1] == 1:
            self.insertDataDB(siemens2, "mes_plc_r12")
        if self.state1[2] == 1:
            self.insertDataDB(siemens3, "mes_plc_r13")
        if self.state1[3] == 1:
            self.insertDataDB(siemens4, "mes_plc_r14")
        if self.state1[4] == 1:
            self.insertDataDB(siemens5, "mes_plc_r15")
