...
class ReadS71200(object):
    ...
    def main(self):
        self.read_data_plc(siemens1, "mes_plc")
        self.read_data_plc(siemens2, "mes_plc_r2")
        self.read_data_plc(siemens3, "mes_plc_r3")
        self.read_data_plc(siemens4, "mes_plc_r4")
        self.read_data_plc(siemens5, "mes_plc_r5")
        self.read_data_plc(siemens6, "mes_plc_r6")
...
@app.route("/plc/<plc_ip>/<style>/<count>/")
def write_data_plc(plc_ip,style,count):
    count = int(count)
    if plc_ip == "192.168.1.10":
        STYLE = siemens1.WriteString("DB34.0", style)
        countA = siemens1.WriteInt16("DB34.18", count)
        if STYLE.IsSuccess:
            print("产品型号写入成功")
        else:
            print("产品型号写入错误：" + STYLE.Message)
        if countA.IsSuccess:
            ...
            print("当班加工数量写入错误", countA.Message)
    elif plc_ip == "192.168.1.20":
        STYLE = siemens2.WriteString("DB34.0", style)
        countA = siemens2.WriteInt16("DB34.18", count)
        if STYLE.IsSuccess:
            print("产品型号写入成功")
        else:
            print("产品型号写入错误：" + STYLE.Message)
        if countA.IsSuccess:
            ...
            print("当班加工数量写入错误", countA.Message)
    elif plc_ip == "192.168.1.30":
        STYLE = siemens3.WriteString("DB34.0", style)
        countA = siemens3.WriteInt16("DB34.18", count)
        if STYLE.IsSuccess:
            print("产品型号写入成功")
        else:
            print("产品型号写入错误：" + STYLE.Message)
        if countA.IsSuccess:
            ...
            print("当班加工数量写入错误", countA.Message)
    elif plc_ip == "192.168.1.40":
        STYLE = siemens4.WriteString("DB34.0", style)
        countA = siemens4.WriteInt16("DB34.18", count)
        if STYLE.IsSuccess:
            print("产品型号写入成功")
        else:
            print("产品型号写入错误：" + STYLE.Message)
        if countA.IsSuccess:
            ...
            print("当班加工数量写入错误", countA.Message)
    elif plc_ip == "192.168.1.50":
        STYLE = siemens5.WriteString("DB34.0", style)
        countA = siemens5.WriteInt16("DB34.18", count)
        if STYLE.IsSuccess:
            print("产品型号写入成功")
        else:
            print("产品型号写入错误：" + STYLE.Message)
        if countA.IsSuccess:
            ...
            print("当班加工数量写入错误", countA.Message)
    elif plc_ip == "192.168.1.60":
        STYLE = siemens6.WriteString("DB34.0", style)
        countA = siemens6.WriteInt16("DB34.18", count)
        if STYLE.IsSuccess:
            print("产品型号写入成功")
        else:
            print("产品型号写入错误：" + STYLE.Message)
...
def plc_write():
    #http://127.0.0.1:5000/plc/plc的IP地址/产品型号/当班加工数量/
    app.run()
