...
class ReadS71200(object):
    ...
    def insert_data(self, data):
        sql = "insert into mes_plc(product_type, r1_equipment_status, recerve,\
              ...
              (data["product_type"], data["r1_equipment_status"], data["recerve"],
    ...
    def read_data(self):
        try:
            ...
            Recerve = self.siemens.ReadInt16("DB33.16")
            #预留
