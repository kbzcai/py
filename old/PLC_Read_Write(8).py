...
@app.route("/plc/<style>/<count>/")
def write_data_plc(style,count):
    try:
        count = int(count)
        STYLE1 = siemens1.WriteString("DB34.0", style)
        countA1 = siemens1.WriteInt16("DB34.18", count)
        if STYLE1.IsSuccess:
            print("产品型号写入成功")
        else:
        ...
        STYLE2 = siemens2.WriteString("DB34.0", style)
        countA2 = siemens2.WriteInt16("DB34.18", count)
        if STYLE2.IsSuccess:
            print("产品型号写入成功")
        else:
        ...
        STYLE3 = siemens3.WriteString("DB34.0", style)
        countA3 = siemens3.WriteInt16("DB34.18", count)
        if STYLE3.IsSuccess:
            print("产品型号写入成功")
        else:
        ...
        STYLE4 = siemens4.WriteString("DB34.0", style)
        countA4 = siemens4.WriteInt16("DB34.18", count)
        if STYLE4.IsSuccess:
            print("产品型号写入成功")
        else:
        ...
        STYLE5 = siemens5.WriteString("DB34.0", style)
        countA5 = siemens5.WriteInt16("DB34.18", count)
        if STYLE5.IsSuccess:
            print("产品型号写入成功")
        else:
        ...
        STYLE6 = siemens6.WriteString("DB34.0", style)
        countA6 = siemens6.WriteInt16("DB34.18", count)
        if STYLE6.IsSuccess:
            print("产品型号写入成功")
        else:
